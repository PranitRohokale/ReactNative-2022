            ...
            expenses: [
                {
                    ...
                    title: "Toys",
                    description: "toys",
                    location: "Local-vocal Toy Store",
                    total: 25.00,
                    status: confirmStatus,
                },
                {
                    ...
                    location: "Local-vocal Baby Care Store",
                    total: 100.00,
                    status: pendingStatus,
                },
                {
                    ...
                    title: "Pampers",
                    description: "Pampers",
                    location: "Local-vocal Supermarket",
                    total: 100.00,
                    status: pendingStatus,
                },
                {
                    ...
                    title: "Baby T-Shirt",
                    description: "T-Shirt",
                    location: "Local-vocal Fashion Store",
                    total: 20.00,
                    status: pendingStatus,
                },
            ],
    ...
    function renderHeader() {
        return (
            <View style={{ paddingHorizontal: SIZES.padding, paddingVertical: SIZES.padding, backgroundColor: COLORS.white }}>
                <View>
                    <Text style={{ color: COLORS.primary, ...FONTS.h2 }}>Pranit Expenses</Text>
                ...
                <View style={{ flexDirection: 'row', marginTop: SIZES.padding, alignItems: 'center' }}>
                    ...
                    <View style={{ marginLeft: SIZES.padding }}>
                        <Text style={{ color: COLORS.primary, ...FONTS.h3 }}>22 March, 2022</Text>
                        <Text style={{ ...FONTS.body3, color: COLORS.darkgray }}>21% more than last month</Text>
                    </View>
                </View>
            </View>
        )
    ...
    function renderIncomingExpenses() {
        ...
        const renderItem = ({ item, index }) => (
            <View style={{
                ...
                >
                    <Text style={{ color: COLORS.white, ...FONTS.body3 }}>CONFIRM {item.total.toFixed(2)} ₹</Text>
                </View>
            </View>
        )
